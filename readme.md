Trabalho de API Rick and Morty Integrantes: Davi Ribeiro, Ashly Arcia, Anna Helloiza, Diego Gabriel e Gustavo Ananias. Todos os integrantes participaram do projeto.
...
Problemas: O projeto não fluiu tão bem quanto desejávamos, algumas dificuldades pequenas, porém, conseguimos ajustar e arrumar em conjunto. Os integrantes conseguiram implementar o código bem em suas páginas.

OBS: MUITO PROVAVELMENTE TEM PÁGINAS QUE ESTÃO BUGADAS, NO MEU PC (GUSTAVO) RODARAM NORMALMENTE TODAS AS FUNÇÕES.
